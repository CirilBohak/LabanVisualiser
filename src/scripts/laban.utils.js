// Create initialised 2D array
var get2DArray = function (size) {
    size = size > 0 ? size : 0;
    var arr = [];
...
// Create initialised 3D array
var get3DArray = function (size1, size2) {
    size1 = size1 > 0 ? size1 : 0;
    var arr = [];

    while(size1--) {
        arr.push(get2DArray(size2));
    }
...
/*
getFileFromServer("./beauty.n", function(text) {
    if (text === null) {
        // An error occurred
    }
    else {
...
// add leading zeros to int number
